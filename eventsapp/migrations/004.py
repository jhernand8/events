    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_time_ms', models.BigIntegerField(unique=False, verbose_name='Event date UTC offset ms', blank=True, null=True)),
                ('event_id', models.TextField(unique=False, verbose_name='Meetup event id in Meetup')),
                ('city', models.TextField(unique=False, verbose_name='Meetup  location city', blank=True, null=True)),
